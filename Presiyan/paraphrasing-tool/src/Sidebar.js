...
const useStyles = makeStyles((theme) => ({
  sidebar: {
    ...
    backgroundColor: '#fff',
    borderRadius: 7,
    width: 60, // Increased to accommodate icon + padding
    height: '30vh',
    position: 'fixed',
        ...
        <ul className={classes.sidebarNav}>
          <li className={classes.navItem}>
            <a href="#tool" className={classes.navLink}>
              <img src="/paraphrase.png" alt="Tool Icon" className={classes.icon} />
              <span className={classes.toolText}>Paraphrase</span>
            </a>
          </li>
          <li className={classes.navItem}>
            <a href="#tool" className={classes.navLink}>
              <img src="/summary.png" alt="Tool Icon" className={classes.icon} />
              <span className={classes.toolText}>Summary</span>
            </a>
          </li>
          <li className={classes.navItem}>
            <a href="#tool" className={classes.navLink}>
              <img src="/infograph.png" alt="Tool Icon" className={classes.icon} />
